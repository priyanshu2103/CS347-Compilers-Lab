...
stmt_wo_func : arith | func_call SEMI  | switch_case | for_loop | while_loop;
...
type : INT_DECL {decl_type_check=1;} | FLOAT_DECL {decl_type_check=2;};
...
for_first : /* empty */ | var_decl;// | id_list;            // here it only allows int a=0 types not a=0
